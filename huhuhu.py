...
i = 0
j = len(Valence)
st.text("Please wait while we processing your playlist...")
...
st.write("Song list based on your playlist: ")
...
if stress_level<=10 and stress_level>=1 :
    ...
    st.text("Please slide your stress level to continue. ")
...
if depression_prob >= 0.75 :
    ...
    st.write("If you insist, you can contact 1-800-82-0066 or email to info.miasa@gmail.com to get more information about depression")
